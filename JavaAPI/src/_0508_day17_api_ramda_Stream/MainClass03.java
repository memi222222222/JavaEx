...
public class MainClass03 {
	...
	public static void main(String[] args) {
		...
		Set<Integer> r5 =list.stream().filter(a -> 50 <= a ).collect(Collectors.toSet());
		System.out.println(r5);
		
		
		
		System.out.println("\n------------------------------------------------------------------");
		List<Integer> r6 = list.stream().distinct().filter(a -> 50 <= a).collect(Collectors.toList());
		...
		IntStream.rangeClosed(1, 10).forEach( a -> System.out.print(a)); //포함 정수스트림반환
