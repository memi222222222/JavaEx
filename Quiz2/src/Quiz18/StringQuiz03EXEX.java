...
public class StringQuiz03EXEX {
	public static void main(String[] args) {
		...
		System.out.println(palindrome("다쉬합창합시다"));

	}
	public static String palindrome(String word) {
		word = word.replace(" ", "");
		StringBuilder sb = new StringBuilder(word);
		return sb.reverse().toString().equals(word) ? "회문" : "회문아님";

	}


	//	public static String palindrome(String word) {  // 2point
	//
	////		word = word.replace(" ", "");
	////
